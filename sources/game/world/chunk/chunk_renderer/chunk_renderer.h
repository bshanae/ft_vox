...
private :
	...
	inline static const string		path_to_vertex_shader = "resources/shaders/chunk.vertex.glsl";
	inline static const string		path_to_fragment_shader = "resources/shaders/chunk.fragment.glsl";
