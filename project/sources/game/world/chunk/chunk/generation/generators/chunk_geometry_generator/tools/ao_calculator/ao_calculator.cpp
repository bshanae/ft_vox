...
array<float, 4>							ao_calculator::calculate(const block_pointer &block, block_face face)
{
...
float									ao_calculator::calculate(const block_pointer &block, occluder_offsets_type occluder_offsets)
{
	int									count = 0;
